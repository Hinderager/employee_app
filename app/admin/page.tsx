  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 safe-bottom">
      ...
      <div className="px-4 py-6 space-y-4">
        {/* Website Analytics */}
        <button
          onClick={() => router.push("/admin/website-analytics")}
          className="w-full bg-white rounded-2xl shadow-lg p-4 flex items-center justify-between hover:bg-gray-50 transition-colors"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">View traffic and performance</p>
            </div>
          </div>
