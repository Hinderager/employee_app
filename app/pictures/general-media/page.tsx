    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <header className="shadow-sm safe-top" style={{ backgroundColor: '#06649b' }}>
        <div className="px-6 py-4 flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-white">General Media</h1>
      ...
      <div className="px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-topshelf-yellow"
          />
        </div>
        ...
        {mediaFiles.length > 0 && (
          <div className="bg-white rounded-2xl shadow-md p-6">
            ...
            <button
              ...
              disabled={isUploading || !jobNumber.trim()}
              className={`w-full py-3 rounded-lg font-bold text-white ${
                isUploading || !jobNumber.trim()
        ...
        {mediaFiles.length === 0 && (
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
            ...
            <ol className="list-decimal list-inside text-sm text-blue-800 space-y-1">
              <li>Enter the job number (required)</li>
